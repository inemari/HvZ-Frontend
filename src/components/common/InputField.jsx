...
const InputField = ({ label, error, onChange, value, showIcon, iconPath, placeholder }) => {
    ...
    return (
        <div className={`flex focus-within:ring-2 focus-within:ring-customOrange bg-gray-200 border ${localError ? 'border-red-500' : 'border-gray-300'} rounded-md dark:bg-customLightOrange`}>
            {showIcon && (
