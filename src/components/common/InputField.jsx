...
const InputField = ({ label, error, onChange, value, showIcon, iconPath, placeholder }) => {
    ...
    return (<>
        <div className={`flex focus-within:ring-2 focus-within:ring-customOrange border ${localError ? 'border-red-500' : 'border-gray-300'} rounded-md bg-customLightOrange`}><label className="block  text-white text-sm text-start">{label}</label>
